...
from .views import ProductViewSet, CategoryViewSet, LotViewSet, DiscountViewSet
...
# GET	/discounts/list/	List all discounts
# PUT/PATCH	/discounts/{id}/update/	Update a discount
# DELETE	/discounts/{id}/delete/	Delete a discount